Feature: Measure 15 - CV String Component

  Background:
    * def measureId = '15CVStringComponent'

  Scenario: Evaluate and Validate Measure 15
    ...
    * def expectedReportRaw = read('classpath:expected-results/15CVStringComponentResponse.json')
