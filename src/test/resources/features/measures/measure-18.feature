Feature: Measure 18 - Cohort Boolean No Start

  Background:
    * def measureId = '18CohortBooleanNoStart'

  Scenario: Evaluate and Validate Measure 18
    ...
    * def expectedReportRaw = read('classpath:expected-results/18CohortBooleanNoStartResponse.json')
