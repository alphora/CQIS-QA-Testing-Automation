Feature: Measure 13 - CV Date No Stratifiers

  Background:
    * def measureId = '13CVDateNoStart'

  Scenario: Evaluate and Validate Measure 13
    ...
    * def expectedReportRaw = read('classpath:expected-results/13CVDateNoStartResponse.json')
