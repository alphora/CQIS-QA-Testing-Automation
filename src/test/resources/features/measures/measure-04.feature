Feature: Measure 04 - Proportion Resource with No Start

  Background:
    * def measureId = '4ProportionResourceNoStart'

  Scenario: Evaluate and Validate Measure 04
    ...
    * def expectedReportRaw = read('classpath:expected-results/4ProportionResourceNoStartResponse.json')
