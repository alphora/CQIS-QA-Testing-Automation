Feature: Measure 16 - CV Resource Multi Component

  Background:
    * def measureId = '16CVResourceMultiComponent'

  Scenario: Evaluate and Validate Measure 16
    ...
    * def expectedReportRaw = read('classpath:expected-results/16CVResourceMultiComponentResponse.json')
