Feature: Measure 08 - Ratio Resource with No Stratifiers

  Background:
    * def measureId = '8RatioResourceNoStrat'

  Scenario: Evaluate and Validate Measure 08
    ...
    * def expectedReportRaw = read('classpath:expected-results/8RatioResourceNoStratResponse.json')
