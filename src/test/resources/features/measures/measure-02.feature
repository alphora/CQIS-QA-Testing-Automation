Feature: Measure 02 - Proportion Boolean with Component Stratifiers

  Background:
    * def measureId = '2ProportionBooleanComponentStratSDEMulti'

  Scenario: Evaluate and Validate Measure 02
    ...
    * def expectedReport = read('classpath:expected-results/2ProportionBooleanComponentStratSDEMultiResponse.json')
