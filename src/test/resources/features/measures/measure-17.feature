Feature: Measure 17 - Cohort Boolean Multi Component

  Background:
    * def measureId = '17CohortBooleanMultiComponent'

  Scenario: Evaluate and Validate Measure 17
    ...
    * def expectedReportRaw = read('classpath:expected-results/17CohortBooleanMultiComponentResponse.json')
