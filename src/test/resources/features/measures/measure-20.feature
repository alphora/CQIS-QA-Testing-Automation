Feature: Measure 20 - Cohort Resource No Start

  Background:
    * def measureId = '20CohortResourceNoStart'

  Scenario: Evaluate and Validate Measure 20
    ...
    * def expectedReportRaw = read('classpath:expected-results/20CohortResourceNoStartResponse.json')
