Feature: Measure 19 - Cohort String No Start

  Background:
    * def measureId = '19CohortStringNoStart'

  Scenario: Evaluate and Validate Measure 19
    ...
    * def expectedReportRaw = read('classpath:expected-results/19CohortStringNoStartResponse.json')
