Feature: Measure 07 - Ratio String Criteria

  Background:
    * def measureId = '7RatioStringCriteria'

  Scenario: Evaluate and Validate Measure 07
    ...
    * def expectedReportRaw = read('classpath:expected-results/7RatioStringCriteriaResponse.json')
