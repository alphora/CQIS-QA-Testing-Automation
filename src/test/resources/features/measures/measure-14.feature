Feature: Measure 14 - CV Boolean No Stratifiers

  Background:
    * def measureId = '14CVBooleanNoStart'

  Scenario: Evaluate and Validate Measure 14
    ...
    * def expectedReportRaw = read('classpath:expected-results/14CVBooleanNoStartResponse.json')
