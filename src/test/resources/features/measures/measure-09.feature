Feature: Measure 09 - Ratio Continuous Variable Date Basis with Component Stratifiers

  Background:
    * def measureId = '9RatioCVDateBasisComponent'

  Scenario: Evaluate and Validate Measure 09
    ...
    * def expectedReportRaw = read('classpath:expected-results/9RatioCVDateBasisComponentResponse.json')
